...
------------------------------------------------------------------------
myStartupHook = do
          spawnOnce "/home/larry/.xmonad/scripts/autostart.sh &"
...
myKeys =
    ...
    --- My Applications (Super+Alt+Key)
	    ...
	    , ("M-M1-g", spawn "google-chrome")
	    , ("M-M1-b", spawn "/usr/bin/bitwarden")

    --- My Scratchpads
        , ("M1-1", namedScratchpadAction myScratchPads "terminal")
        , ("M1-2", namedScratchpadAction myScratchPads "ncmpcpp")
        , ("M1-3", namedScratchpadAction myScratchPads "ranger")
